...
import edu.usal.pantalla.vista.eventos.CapturaBtnVuelos_Mostrar;
...
public class Vuelo_Mostrar_Vista extends JFrame {
	...
	private Vuelo_Mostrar_Controller controller;
	

	public Vuelo_Mostrar_Vista(Vuelo_Mostrar_Controller vuelo_Mostrar_Controller) {
		this.controller = vuelo_Mostrar_Controller;
		...
		JLabel lblBuscarCliente = new JLabel("Mostrando  vuelos");
		...
		btnVolver.addActionListener(new CapturaBtnVuelos_Mostrar(this));
		...
		btnSeleccionar.addActionListener(new CapturaBtnVuelos_Mostrar(this));
	...
	public Vuelo_Mostrar_Controller getController() {
		return controller;
	}


	public void setController(Vuelo_Mostrar_Controller controller) {
